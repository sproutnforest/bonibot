...
app.controller('MyController', function($scope, $http) {
  ...
  $scope.chatInput = "";
  $scope.items = [];
  // TODO: Update this URL to point to the combined PJOK + PKN model endpoint
  const boturl = 'https://grub-robust-positively.ngrok-free.app/webhook/589ecd25-f089-4975-9b4f-0ec051b403b4';
  ...
  if(!student || !grade){
    window.location.href = "/register?model=3";
  }
