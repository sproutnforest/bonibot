...
app.controller('MyController', function($scope, $http) {
  ...
  $scope.chatInput = "";
  $scope.items = [];
  // TODO: Update this URL to point to the PKN model endpoint
  const boturl = 'https://grub-robust-positively.ngrok-free.app/webhook/2d5af878-c3a5-45bd-9545-a85beda93f1f';
  ...
  if(!student || !grade){
    window.location.href = "/register?model=2";
  }
